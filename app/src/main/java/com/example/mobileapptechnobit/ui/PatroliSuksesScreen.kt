...
@Composable
fun PatroliSuksesScreen(navController: NavController, token: String) {
    Scaffold(
        content = { paddingValues ->
            Box(
                ...
                Column(
                    ...
                    Text(
                        text = "Data patroli berhasil disimpan",
                        fontSize = 14.sp,
                        fontFamily = robotoFontFamily,
...
@Composable
fun PatroliSuksesScreenPreview() {
    PatroliSuksesScreen(navController = rememberNavController(), token = "dummy_token")
}